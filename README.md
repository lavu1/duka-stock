...
- Hosted access uses Sites account authentication. An external Alexa client still needs supported authentication and cross-device review handoff.
- No merchant trial, microphone/device compatibility study, public video, public GitHub repository, or Devpost submission is claimed complete.
